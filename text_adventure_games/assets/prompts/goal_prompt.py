gpt_goals_prompt = (
    ...
    "scale of 1 to {Goals.max_progress_score}. This score tells you how well your actions advanced completion of the "
    "goal, with 1 meaning almost no progress was made towards the goal and {Goals.max_progress_score} meaning the "
...
impartial_evaluate_goals_prompt = (
    "You are an impartial evaluator. On a scale of 1 to {Goals.max_progress_score}, give an integer for each "
...
persona_evaluate_goals_prompt = (
    "On a scale of 1 to {Goals.max_progress_score}, give an integer for each priority tier that evaluates whether "
    "the goal was achieved or not with 1 being almost no progress towards the goal and {Goals.max_progress_score} "
