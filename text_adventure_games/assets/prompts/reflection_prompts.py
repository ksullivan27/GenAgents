...
gpt_generalize_prompt = (
    """Based on your character and goals described above, you need to reflect upon your previous reflections and """
    """observations to improve your understanding of the environment and how to act within it. This could also """
    """include considering how to improve your past actions to be more efficient with respect to achieving your """
    """goals. You'll be given your current impressions of all other agents, your prior reflections, and action """
    """statements that you and other agents around you have made. From these impressions, reflections, and memories, """
    """try to:\n1.) identify only the most impactful new elaborations on previous reflections or new generalizations """
    """about your actions or the environment.\n2.) update previous reflections if they no longer appear to be true."""
    """\n\nSeparate your new and revised reflections. Prior reflections are each associated with an ID; if you """
    """update a reflection use this ID as the key for the statement that you have updated. Only return a JSON """
    """object, using the following structure:\n\n"""
    """{"new": [{"statement": "a new generalized knowledge statement"}], """
    """"updated": [{"index": index of prior statement, "statement": "updated/revised knowledge statement"}]}\n\n"""
    """Remember, make generalized statements that are rooted in the facts you're been provided, and only update past """
    """reflections if they no longer seem accurate."""
)
...
memory_query_questions = [
    ...
    (
        """Which strategies have been effective so far, and how should I adjust my overall game plan to align with """
        """the evolving dynamics of the game?"""
    ),
]

insight_question = (
    """What five high-level insights can you infer from the above statements? You can make new and/or updated """
    """generalizations, but there should be no more than five in total."""
)
